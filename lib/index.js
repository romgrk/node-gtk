...
function makeInterface(info) {
    ...
    interface.info = info;
    interface.gtype = GIRepository.registered_type_info_get_g_type(info);
    interface.properties = Object.create(null);
    ...
    for (let i = 0; i < n_properties; i++) {
        ...
        interface.properties[propertyName] = propertyInfo;
    }
