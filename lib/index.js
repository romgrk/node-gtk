...
function makeInterface(info) {
    ...
    forLoopFn(info, GI.interface_info_get_n_properties, GI.interface_info_get_property, (propInfo) => {
        constructor.properties.push(getPropertyDescription(propInfo))
    })

    /* forLoopFn(info, GI.interface_info_get_n_vfuncs, GI.interface_info_get_vfunc, (methodInfo) => {
