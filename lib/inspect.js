...
function FunctionInfo(info, parent) {
    ...
    this.is_method      = this._flags & GI.FunctionInfoFlags.IS_METHOD
    this.is_constructor = this._flags & GI.FunctionInfoFlags.IS_CONSTRUCTOR
    this.is_getter      = this._flags & GI.FunctionInfoFlags.IS_GETTER
    this.is_setter      = this._flags & GI.FunctionInfoFlags.IS_SETTER
}
...
function formatFunction(fn) {
    const parent = fn.parent ? (fn.parent.name ? fn.parent.name : fn.parent) : ''
    return (
...
function formatType(type) {
    ...
    if (type.type === 'glist' || type.tag === 'gslist')
