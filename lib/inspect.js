...
function FunctionInfo(info, parent) {
    ...
    this.isMethod      = this._flags & GI.FunctionInfoFlags.IS_METHOD
    this.isConstructor = this._flags & GI.FunctionInfoFlags.IS_CONSTRUCTOR
    this.isGetter      = this._flags & GI.FunctionInfoFlags.IS_GETTER
    this.isSetter      = this._flags & GI.FunctionInfoFlags.IS_SETTER
}
